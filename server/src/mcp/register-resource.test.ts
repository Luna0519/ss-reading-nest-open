...
describe("registerReadingResource", () => {
  it("uses an app-v17 resource with standard and ChatGPT legacy CSP access to the deployed Worker origin", async () => {
    ...
    expect(READING_NEST_URI).toBe("ui://ss-reading-nest/app-v17.html");
    expect(uri).toBe("ui://ss-reading-nest/app-v17.html");
    ...
    expect(loaded.contents[0].uri).toBe("ui://ss-reading-nest/app-v17.html");
